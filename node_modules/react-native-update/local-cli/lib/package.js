...
const commands = exports.commands = {
  uploadIpa: function () {
    var ref = _asyncToGenerator(function* (_ref2) {
      ...
      var _ref5 = yield post(`/app/${ appId }/package/create`, {
        name,
        hash
      });
  ...
  uploadApk: function () {
    var ref = _asyncToGenerator(function* (_ref6) {
      ...
      var _ref7 = yield (0, _app.getSelectedApp)('android');
  ...
  packages: function () {
    var ref = _asyncToGenerator(function* (_ref10) {
      ...
      var _ref11 = yield (0, _app.getSelectedApp)(platform);
